...
1. Generate a descriptive Title. STRICT RULES FOR TITLE:
   - The final total length MUST be EXACTLY OR LESS THAN ${titleLength} characters.
   - It MUST be a fully complete, cohesive sentence. NEVER end abruptly.
   - ${transparentBackground ? 'You MUST append the exact phrase " isolated on transparent background" at the very end of the title.' : ''}
   - ${whiteBackground && !transparentBackground ? 'You MUST append the exact phrase " isolated on white background" at the very end of the title.' : ''}
   - To ensure the entire phrase fits within the ${titleLength} character limit, concisely describe the subject, action, and setting, keeping the descriptive part very short if needed.
