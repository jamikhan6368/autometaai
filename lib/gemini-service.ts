...
   - The total length MUST be EXACTLY OR LESS THAN ${titleLength} characters.
   - It MUST be a fully complete, cohesive sentence. 
   - NEVER end the sentence abruptly or leave it incomplete.
   - To ensure it fits, concisely describe the subject, action, and setting.
